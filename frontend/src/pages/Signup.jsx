...
const Signup = () => {
    ...
    useEffect(() => {
        document.title = "TaskNexus | Signup";
    }, []);
    ...
    const handleErrors = (errors) => {
        ...
        let usernameErrors = errors.filter((error) =>
            /\busername\b/i.test(error)
        );
    ...
    return (
        <AuthLayout>
            <form
                ...
                className="flex flex-col w-4/5 sm:max-w-xs sm:w-full"
            >
                ...
                <Input
                    ...
                    type="text"
                    placeholder="e.g. asgard.ragnarok@gmail.com"
                    classNames="bg-white text-black rounded-sm text-sm  w-full p-2 outline-none "
                    value={email}
                    onChange={(e) => {
                        if (message) setMessage("");
