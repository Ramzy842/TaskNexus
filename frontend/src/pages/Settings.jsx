...
const PasswordChange = ({ loading }) => {
    ...
    return (
        !loading && (
            <div className={`bg-cyan-950 rounded-sm mb-4 ${edit ? "pb-4" : ""}`}>
                <div className=" rounded-sm p-2 md:py-1 md:px-1 md:pl-4 md:flex items-center justify-between ">
                    ...
                    {!edit && (
                        <div
                            ...
                            className={`flex justify-center items-center bg-cyan-600 hover:bg-cyan-700
                        rounded-sm py-2 px-4 cursor-pointer`}
                        >
                            <img
                                src="/src/assets/edit-settings.svg"
                                alt="edit"
                            />
                ...
                {edit && (
                    <form action="#" className="px-4 py-2 w-full">
                        ...
                        <div
                            ...
                            className="flex justify-center items-center bg-yellow-600 hover:bg-yellow-700 rounded-sm py-2 px-4 cursor-pointer w-full md:w-sm"
                        >
                            <Button
                                type="button"
                                text="Cancel"
            ...
            <div className="flex md:flex-col justify-between items-start">
                <div className="flex flex-col md:mb-2">
                    ...
                    <p className="text-xs w-11/12 font-light text-gray-600">
                        ...
                        tasks and personal information, will be permanently
...
const Settings = () => {
    ...
    useEffect(() => {
        if (user)
            setShowInfo(
                Object.hasOwn(user, "googleId") ? false : true
            );
    }, [user]);
    return (
        <DashboardLayout>
            <h1 className="font-medium text-xl text-teal-950 mb-4">
                My Account
            </h1>
            {loading ? (
                <SkeletonSettings />
