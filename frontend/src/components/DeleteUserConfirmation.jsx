...
const DeleteUserConfirmation = () => {
    return (
        <div className="absolute bg-black/50 backdrop-blur-sm top-0 right-0 left-0 bottom-0 overflow-hidden flex items-center justify-center ">
            <div className="rounded-sm bg-gray-200 p-4 max-w-xs md:max-w-lg">
                ...
                <div className="flex items-center gap-x-2 max-w-xs ml-auto">
                    <div className="flex justify-center items-center bg-gray-600 hover:bg-gray-700 rounded-sm py-2 px-4 cursor-pointer w-full md:w-sm">
                        <Button
                            type="button"
                            text="Cancel"
                    ...
                    <div className="flex justify-center items-center bg-green-600 hover:bg-green-700 rounded-sm py-2 px-4 cursor-pointer w-full md:w-sm">
                        <Button
                            type="button"
                            text="Confirm"
                            classNames="text-white font-semibold text-sm  select-none cursor-pointer"
