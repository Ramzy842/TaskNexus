...
const FormActions = ({ setFormIsOpen }) => {
    return <div className="flex justify-center sm:flex-col sm:items-center gap-x-2">
        <div className="flex justify-center items-center bg-cyan-600 hover:bg-cyan-700 rounded-md p-3 cursor-pointer sm:mb-2 w-full">
        ...
        <div className="flex justify-center items-center bg-yellow-600 hover:bg-yellow-700 rounded-md p-3 cursor-pointer sm:mb-2 w-full" onClick={() => setFormIsOpen(false)}>
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
