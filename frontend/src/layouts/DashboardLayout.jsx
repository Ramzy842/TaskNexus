...
const DashboardLayout = ({ children }) => {
	return (
		<div className="grid grid-rows-[auto_1fr] max-h-screen h-screen overflow-hidden bg-[#C2D0CE] p-4">
			...
			<div className="w-full absolute bottom-4 right-4 left-1/2 -translate-x-1/2 flex justify-end max-w-6xl mx-auto px-4 md:px-0">
